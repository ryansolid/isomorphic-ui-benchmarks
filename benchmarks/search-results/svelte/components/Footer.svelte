                ...
                <ul>
                  ...
                  <li className="gf-li">
                    <a
                      ...
                      _sp="m571.l2895"
                      className="thrd">Registration</a>
                  </li>
                  <li className="gf-li">
                    <a
                      href="http://pages.ebay.com/ebay-money-back-guarantee/"
                      _sp="m571.l4539"
                      className="thrd">eBay Money Back Guarantee</a>
                  </li>
                  <li className="gf-li">
                    <a
                      href="http://pages.ebay.com/help/buy/basics.html"
                      _sp="m571.l2897"
                      className="thrd">Bidding &amp; buying help</a>
                  </li>
                  <li className="gf-li">
                    <a
                      href="http://stores.ebay.com"
                      _sp="m571.l2899"
                      className="thrd">Stores</a>
                  </li>
                  <li className="gf-li">
                    <a
                ...
                <ul>
                  ...
                  <li className="gf-li">
                    <a
                      ...
                      _sp="m571.l2907"
                      className="thrd">Security center</a>
                  </li>
                  <li className="gf-li">
                    <a
                      href="http://viv.ebay.com/ws/eBayISAPI.dll?EbayTime"
                      _sp="m571.l2908"
                      className="thrd">eBay official time</a>
                  </li>
                  <li className="gf-li">
                    <a
                ...
                <ul>
                  ...
                  <li className="gf-li">
                    <a
                      ...
                      _exsp="m571.l3208"
                      className="thrd">StubHub</a>
                  </li>
                  <li className="gf-li">
                    <a
                      href="https://www.close5.com"
                      _exsp="m571.l3360"
                      className="thrd">Close5</a>
                  </li>
                  <li className="gf-li">
                    <a
                  ...
                  <li className="gf-li">
                    <a
                      ...
                      _exsp="m571.l2942"
                      className="thrd gf-i">
                      <i className="gspr icfbg">Facebook </i></a><i
                      className="gspr icfbg" />
                  </li><i className="gspr icfbg">
                    <li className="gf-li">
                      <a
                        href="http://twitter.com/#!/eBay"
                        _exsp="m571.l2943"
                        className="thrd gf-i">
                        <i className="gspr ictwg">Twitter </i></a><i
                        className="gspr ictwg" />
                    </li><i className="gspr ictwg">
                      <li className="gf-li">
                        <a
                          href="https://plus.google.com/+eBay/posts"
                          _exsp="m571.l3223"
                          className="thrd gf-i">
                          <i className="gspr icgpg">Google+ </i></a><i
                          className="gspr icgpg" />
                      </li><i className="gspr icgpg" /></i></i>
                </ul><i className="gspr icfbg"><i className="gspr ictwg"><i
                      className="gspr icgpg" /></i></i>
              </td>
              <td>
                <ul>
                  <li className="gf-li">
                ...
                <ul>
                  ...
                  <li className="gf-li">
                    <a
                      ...
                      _sp="m571.l1613"
                      className="thrd">Seller Information Center</a>
                  </li>
                  <li className="gf-li">
                    <a
                        ...
                        <ul className="gf-ful" role="navigation">
                          ...
                          <li className="gf-f-li3">
                            <a
                              ...
                              <b className="flgb gf-if gspr" />United Kingdom
                            </a>
                          </li>
                          <li className="gf-f-li3">
                            <a
          ...
          <tbody>
                ...
                <ul id="gf-l" className="gf-lb">
                  ...
                  <li className="gf-li">
                    <a
                      href="http://announcements.ebay.com"
                      _exsp="m571.l2935"
                      className="thrd gf-bar-a">Announcements</a>
                  </li>
                  <li className="gf-li">
                    <a
                      href="http://community.ebay.com"
                  ...
                  <li className="gf-li">
                    <a
                      href="http://pages.ebay.com/securitycenter/index.html"
                      _exsp="m571.l2616"
                      className="thrd gf-bar-a">Security Center</a>
                  </li>
                  <li className="gf-li">
                    <a
                      href="http://resolutioncenter.ebay.com/"
                      _sp="m571.l1619"
                      className="thrd gf-bar-a">Resolution Center</a>
                  </li>
                  <li className="gf-li">
                    <a
                      href="http://pages.ebay.com/sellerinformation/index.html"
                  ...
                  <li className="gf-li">
                    <a
                      href="http://pages.ebay.com/help/policies/overview.html"
                      _exsp="m571.l2604"
                      className="thrd gf-bar-a">Policies</a>
                  </li>
                  <li className="gf-li">
                    <a
                      href="https://www.ebaypartnernetwork.com/files/hub/en-US/index.html"
                  ...
                  <li className="gf-li">
                    <a
                      href="http://pages.ebay.com/sitemap.html"
                      _exsp="m571.l2909"
                      className="thrd gf-bar-a">Site Map</a>
                  </li>
                </ul>
              </td>
            </tr>
            <tr valign="top">
              <td className="gf-legal">
                Copyright © 1995-2016 eBay Inc. All Rights Reserved. <a
                  href="http://pages.ebay.com/help/policies/user-agreement.html">
                  User Agreement
                </a>, <a
                  href="http://pages.ebay.com/help/policies/privacy-policy.html">Privacy</a>,
                <a
                  href="http://pages.ebay.com/help/account/cookies-web-beacons.html">
                  Cookies
                </a> and <a href="http://cgi6.ebay.com/ws/eBayISAPI.dll?AdChoiceLandingPage&partner=0" id="gf-AdChoice">AdChoice</a>
              </td>
            </tr>
          </tbody>
        </table>
