                ...
                <ul>
                  ...
                  <li class="gf-li">
                    <a
                      ...
                      _sp="m571.l2895"
                      class="thrd">Registration</a>
                  </li>
                  <li class="gf-li">
                    <a
                      href="http://pages.ebay.com/ebay-money-back-guarantee/"
                      _sp="m571.l4539"
                      class="thrd">eBay Money Back Guarantee</a>
                  </li>
                  <li class="gf-li">
                    <a
                      href="http://pages.ebay.com/help/buy/basics.html"
                      _sp="m571.l2897"
                      class="thrd">Bidding &amp; buying help</a>
                  </li>
                  <li class="gf-li">
                    <a
                ...
                <ul>
                  ...
                  <li class="gf-li">
                    <a
                      ...
                      _sp="m571.l2907"
                      class="thrd">Security center</a>
                  </li>
                  <li class="gf-li">
                    <a
                      href="http://viv.ebay.com/ws/eBayISAPI.dll?EbayTime"
                      _sp="m571.l2908"
                      class="thrd">eBay official time</a>
                  </li>
                  <li class="gf-li">
                    <a
                ...
                <ul>
                  ...
                  <li class="gf-li">
                    <a
                      ...
                      _exsp="m571.l2942"
                      class="thrd gf-i">
                      <i class="gspr icfbg">Facebook </i></a><i
                      class="gspr icfbg" />
                  </li><i class="gspr icfbg">
                    <li class="gf-li">
                      <a
                        href="http://twitter.com/#!/eBay"
                        _exsp="m571.l2943"
                        class="thrd gf-i">
                        <i class="gspr ictwg">Twitter </i></a><i
                        class="gspr ictwg" />
                    </li><i class="gspr ictwg">
                      <li class="gf-li">
                        <a
                          href="https://plus.google.com/+eBay/posts"
                          _exsp="m571.l3223"
                          class="thrd gf-i">
                          <i class="gspr icgpg">Google+ </i></a><i
                          class="gspr icgpg" />
                      </li><i class="gspr icgpg" /></i></i>
                </ul><i class="gspr icfbg"><i class="gspr ictwg"><i
                      class="gspr icgpg" /></i></i>
              </td>
              <td>
                <ul>
                  <li class="gf-li">
                ...
                <ul>
                  ...
                  <li class="gf-li">
                    <a
                      ...
                      _sp="m571.l1613"
                      class="thrd">Seller Information Center</a>
                  </li>
                  <li class="gf-li">
                    <a
                  ...
                  <li class="gf-li">
                    <div class="gf-flags-wpr">
                      <a
                        ...
                        id="gf-fbtn">
                        United States<b class="gf-if gspr flus" />
                ...
                <ul id="gf-l" class="gf-lb">
                  ...
                  <li class="gf-li">
                    <a
                      href="http://announcements.ebay.com"
                      _exsp="m571.l2935"
                      class="thrd gf-bar-a">Announcements</a>
                  </li>
                  <li class="gf-li">
                    <a
                      href="http://community.ebay.com"
                  ...
                  <li class="gf-li">
                    <a
                      href="http://pages.ebay.com/securitycenter/index.html"
                      _exsp="m571.l2616"
                      class="thrd gf-bar-a">Security Center</a>
                  </li>
                  <li class="gf-li">
                    <a
                      href="http://resolutioncenter.ebay.com/"
                      _sp="m571.l1619"
                      class="thrd gf-bar-a">Resolution Center</a>
                  </li>
                  <li class="gf-li">
                    <a
                      href="http://pages.ebay.com/sellerinformation/index.html"
                  ...
                  <li class="gf-li">
                    <a
                      href="http://pages.ebay.com/help/policies/overview.html"
                      _exsp="m571.l2604"
                      class="thrd gf-bar-a">Policies</a>
                  </li>
                  <li class="gf-li">
                    <a
                      href="https://www.ebaypartnernetwork.com/files/hub/en-US/index.html"
                  ...
                  <li class="gf-li">
                    <a
                      href="http://pages.ebay.com/sitemap.html"
                      _exsp="m571.l2909"
                      class="thrd gf-bar-a">Site Map</a>
                  </li>
                </ul>
              </td>
            </tr>
